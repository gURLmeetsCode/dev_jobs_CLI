...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{CLI application that scrapes developer jobs from Stackoverflow.}
  spec.description   = %q{CLI application that scrapes developer jobs from Stackoverflow.}
